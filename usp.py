...
selected_model_name = st.selectbox(
    ...
    index=0,
    help="Gemini 2.0 Flash is the latest experimental model. 1.5 Flash is faster and cost-effective."
)
...
if pdf_bytes:
    ...
    with col2:
        ...
        if analyze_button:
            ...
            result_placeholder.info("Processing... This may take 30-60 seconds depending on the file size.")
            ...
            if analysis:
                ...
                result_placeholder.error("Failed to generate analysis. Please try again or switch models.")
